...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<form action="" id="manage_department">
			...
			<div class="container">
				<button style='margin-left:140px' type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
				<button style='margin-left:10px' type="submit" name="submit" class="btn btn-primary">Save</button>
			</div>
		</form>
	</div>
</div>
